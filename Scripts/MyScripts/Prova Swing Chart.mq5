...
//---- indicators
   ...
   SetIndexLabel(1, (string)Period + "-period Swing");
...
void catch_XABC(){
   ...
   A_dt = sDateTime[total_swing_pt - 2];//Comment("sDateTime[total_swing_pt - 2]: ",IntegerToString(sDateTime[total_swing_pt - 2],0,Symbol()) );
   A_pos = 2;
...
void show_XABC(){
   ...
   if (X_pt < A_pt){
      ...
      ObjectSetText("XABC_PSZ_Label", "Sell Below "+DoubleToStr(A_pt-ABdiv8, Digits), 8, XABC_font ,XABC_ME_line_color);
      ObjectSetText("XABC_PBZ_Label", "Buy Above "+DoubleToStr(B_pt+ABdiv8, Digits), 8, XABC_font ,XABC_ME_line_color);
      ...
      ObjectSetText("XABC_PSZ_Label", "Sell Below "+DoubleToStr(B_pt-ABdiv8, Digits), 8, XABC_font ,XABC_ME_line_color);
      ObjectSetText("XABC_PBZ_Label", "Buy Above "+DoubleToStr(A_pt+ABdiv8, Digits), 8, XABC_font ,XABC_ME_line_color);
   ...
   ObjectSetText("XABC_A_Label", "A Trend Reversal "+DoubleToStr(A_pt, Digits), 8, XABC_font ,XABC_ME_line_color);
   ...
   ObjectSetText("XABC_A_ME_Label", "Max Extension "+DoubleToStr(A_pt+ME, Digits), 8, XABC_font ,XABC_ME_line_color);

   ObjectCreate("XABC_B", OBJ_TREND, 0, B_dt, B_pt, Time[0], B_pt);
   ObjectCreate("XABC_B_Label", OBJ_TEXT, 0, Time[0]+Period()*60*align, B_pt);
   ObjectSetText("XABC_B_Label", "B Trend Reversal "+DoubleToStr(B_pt, Digits), 8, XABC_font ,XABC_ME_line_color);
   ...
   ObjectSetText("XABC_B_ME_Label", "Max Extension "+DoubleToStr(B_pt-ME, Digits), 8, XABC_font ,XABC_ME_line_color);
...
void catch_swing_pt_ex(){
   double imp_mean, sw_pt_1, sw_pt_2;
   int i, spt, count;
   datetime pt_1_dt=0;datetime pt_2_dt=0;
   bool imp_mean_hit;
