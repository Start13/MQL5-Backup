...
input double fractal_slow_factor = 6.0;      // Fractal slow Factor
 bool SetGlobals=true;                 // Set terminal global variables
...
input color Text_color = clrDimGray;           // Text Color
...
input string             btn_text              = "SHVED";              // a button name
...
input int                button_x              = 100;                // x coordinate of the button
...
input string             UniqueButtonID        = "SupplyDemand";   // Unique ID for each button                         
